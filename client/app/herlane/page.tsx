...
export default function HerLanePage() {
  ...
  const content = {
    ...
    benefits: [
      ...
      {
        icon: "🎲",
        title: "Daily Picks Lane",
        desc: "Daily game picks, trending odds, and fun ways to play",
      },
      {
        icon: "🌍",
  ...
  const primaryColor = "#E7B8A5";
  const textColor = "#2F3439";
  const accentColor = "#F9D9E3";
